...
| ADR | Decision |
|---|---|
| [0001](0001-freeze-v11-as-reference.md) | The approved v11 render is a frozen, pixel-exact contract. Paths amended by 0010, 0011 and 0012 |
...
| [0008](0008-component-contract.md) | One React-inspired component contract: ctx first, data, props, slots, scoped styles. Paths amended by 0010, 0011 and 0012 |
...
| [0010](0010-public-monorepo-and-pdf-workflow.md) | Public monorepo, template-owned input schemas and presentation, separate PDF workflow, private revisions and hash-based approval. Engine layout and local PDF workflow implemented 2026-09-16; web application pending. Amends 0005 and 0007; amended by 0011 and 0012. |
