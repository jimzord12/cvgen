...
```powershell
& $T GET "boards/$boardId" -Query @{ fields = 'all'; cards = 'all'; card_attachments = 'true'; card_checklists = 'all'; lists = 'all'; labels = 'all'; checklists = 'all'; actions = 'all'; actions_limit = 1000 } -Pretty > builds/trello-<timestamp>/board.json
```
