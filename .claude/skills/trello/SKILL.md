...
helper refuses to run without them and never prints them. Never paste them
into a card, a commit, a log or the chat. If they are missing, ask the owner
to set them in his own shell; do not ask for the values.
