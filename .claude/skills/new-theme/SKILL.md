...
1. Copy `packages/domains/marine/templates/flagship/themes/silver-bridge.typ` as the pattern: spread `golden-blue`'s
...
1. Copy `packages/domains/marine/templates/flagship/artwork/captain.typ`. Draw SVGs under `packages/domains/marine/assets/<role>/` using
