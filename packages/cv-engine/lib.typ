...
#import "core/primitives.typ": label, rule, metric, duration, duration-value, decoration
...
// Flagship: the marine domain's first template and its sections.
...
#import "domains/marine/templates/flagship/components/sections.typ": section-heading, profile-summary, synopsis
